...
{
    /// <summary>
    /// Registers <see cref="IBacktestingService"/> (implemented by <see cref="BacktestingEngine"/>) as a scoped service, along with the default <see cref="BacktestOptions"/> singleton.
    /// </summary>
    /// <remarks>
