...
{
    /// <summary>
    /// Field info for the inner service field.
    /// </summary>
    private static readonly FieldInfo _innerServiceField = typeof(CachedPriceMonitoringService).GetField(
        "_innerService", BindingFlags.NonPublic | BindingFlags.Instance)
        ?? throw new InvalidOperationException("Cannot find _innerService field");

    /// <summary>
    /// Field info for the cache field.
    /// </summary>
    ...
    /// <summary>
    /// Field info for the logger field.
    /// </summary>
    private static readonly FieldInfo _loggerField = typeof(CachedPriceMonitoringService).GetField(
        ...
        ?? throw new InvalidOperationException("Cannot find _logger field");

    /// <summary>
    /// Field info for the cache duration field.
    /// </summary>
    private static readonly FieldInfo _cacheDurationField = typeof(CachedPriceMonitoringService).GetField(
        ...
        ?? throw new InvalidOperationException("Cannot find _cacheDuration field");
